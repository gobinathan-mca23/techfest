    ...
    >
      <div className="max-w-screen-xl py-10 px-4 sm:px-6 text-dimWhite border-t border-white sm:flex justify-between mx-auto">
        ...
        <div className="p-5 sm:w-2/12 text-center">
          ...
          <ul className='text-sm text-center'>
            <li className="my-2">
              <a className="hover:text-accent" href="https://psgcas.ac.in" rel="noreferrer" target='_blank'>PSGCAS</a>
            </li>
            <li className="my-2">
              <a className="hover:text-accent" href="mailto:idealgobi@gmail.com" rel="noreferrer" target='_top'>Email</a>
            </li>
            <li className="my-2">
              <a className="hover:text-accent" href="https://wa.me/7010037147" rel="noreferrer" target='_blank'>Whatsapp</a>
            </li>
          </ul>
        </div>
      ...
      <div className="flex py-5 m-auto text-dimWhite text-sm flex-col items-center border-t max-w-screen-xl border-white">
        <div className="my-2 text-center leading-6">Developed & Designed by<br /><span className='text-accent'> ⬜◽Unknown_G🤍◽⬜ <span className='text-white'></span> <a href='http://sanjith-portfolio.netlify.app' className='hover:text-white' rel="noreferrer" target='_blank'> </a><span className='text-white'></span> </span></div>
      </div>
    </section>
  )
}
