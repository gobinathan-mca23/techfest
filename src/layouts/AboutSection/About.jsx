...
const AboutSection = () => {
  ...
  setInterval(() => {
    const eventDate = new Date('Mar 13, 2025 00:00:00').getTime();
      ...
      <div className="container max-w-6xl mx-auto px-5 md:px-2">
        {/* <div className="grid grid-cols-1 md:grid-cols-2"> */}
          <div className="about-content-text flex items-center flex-col mb-12">
            ...
            >
              About <span className='text-2xl'>&nbsp;TECH-FEST'25</span>
            </h2>
            <h3
              data-aos="fade-up" data-aos-offset="10"
              data-aos-once="true"  data-aos-delay="0"
            ...
            >
               &nbsp;&nbsp;&nbsp;&nbsp;   TechFest 2K25 at PSG College of Arts and Science is an exciting intra-college event organized by the <b>PG and Research Department of Computer Science -Aided </b>, bringing students together to celebrate technology and innovation. This event features technical competitions, fun activities, and interactive sessions, fostering a spirit of learning and collaboration. It provides a great platform for students to showcase their skills, engage in friendly competition, and enjoy a day of tech-filled excitement within the college community.
            </p>
            <a
              data-aos="fade-up" data-aos-offset="10"
              data-aos-once="true"  data-aos-delay="0"
            ...
            <div role="alert" class="max-w-[300px] p-2 bg-dimBlue rounded-full items-center text-indigo-100 leading-none lg:rounded-full flex lg:inline-flex">
              <span class="flex rounded-full  bg-[#00f7ff76] uppercase px-2 py-1 text-sm font-semibold mr-3">Enjoy the Event</span>
              <span class="font-semibold mr-2 text-left flex-auto">TECH-FEST'25</span>
              <svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" class="fill-current opacity-75 h-4 w-4"></svg>
            </div>
