...
export const eventsDet = [
  ...
  /// 3. AIML Hackathon
  {
    ...
    select: 'Hackathon',
    image: eventImg.aiml,
    form: 'https://forms.gle/UsiFtKTcm5EBW5549',
    type: 'technical',
    rulebook: "https://forms.gle/UsiFtKTcm5EBW5549",
    ...
    info: [
      "CODE TANGLE is a Technical event designed to challenge participants' problem-solving, logical thinking, and coding skills. It consists of three exciting rounds. In Round 1: Technical Puzzle, participants solve logic-based challenges under time constraints. Round 2: Technical Connection tests their ability to identify technical concepts and technical terms through clues or images. Finally, Round 3: Jumbled Code Lines requires participants to arrange shuffled lines of code into the correct order to produce the desired output. The event rewards accuracy, speed, and analytical thinking, making it a perfect challenge for coding enthusiasts."
    ],
    eligibility: [
    ...
    contact: {
      ...
      name: {
        ...
        student: ["VASUNDHARA C - 8870866377", "KAVIYA S - 6385763355"]
      }
    },
  },
  ...
  /// 8. Maze Solver dup
  {
    ...
    image: eventImg.maze,
    form: 'https://forms.gle/HAa5JnexhqV1Qef69',
    type: 'technical',
    rulebook: "https://forms.gle/HAa5JnexhqV1Qef69",
    tag: " Prizes worth ₹7000",
    fee: "RS 500(PER TEAM)",
    deadline: "12 MARCH 2025",
    teamCount: [
    ...
    info: [
      " Tech Xplorer is a thrilling technical event that challenges participants through three engaging rounds. The first round, Logo Quiz, tests their ability to recognize and identify various tech-related logos. Next, in Tech Riddles, participants must solve thought-provoking riddles based on technology and innovation. Finally, the X and Y round presents logical and analytical challenges that push contestants to think critically and apply their technical knowledge. This event is perfect for tech enthusiasts who enjoy puzzles, problem-solving, and a competitive spirit. Get ready to explore the world of technology like never before!",
    ...
    contact: {
      name: {
        ...
        student: ["SUMAN V - 8072628798", "SANTHOSH M - 8883499261"]
      },
      info: "bitvprayukti@bitsathy.ac.in"
    },
  },
...
/// 5. Puzzle
  ...
  /// 8. Da vinci's newspaper
  {
    ...
    form: 'https://forms.gle/8BzXm7Z5ttbVG31U8',
    type: "nonTechnical",
    rulebook: "https://forms.gle/8BzXm7Z5ttbVG31U8",
    ...
    info: [
      "Immerse yourself in the Quiz — a versatile intellectual challenge. Sharpen your mind with eccentric thinking and engage in diverse questions covering general knowledge. The participant atop the leaderboard claims victory, showcasing convincing knowledge in this engaging competition."
    ],
    eligibility: [
      "Open to all students from any background with valid ID cards."
    ],
    contact: {
      name: {
        ...
        student: ["Thrisha - 9342377169", "Jaya Bharathi - 8220386644"]
      },
      info: "bitvprayukti@bitsathy.ac.in"
    }
  },
/// 1. Quiz
{
  ...
  select: 'IPL AUCTION',
  image: eventImg.robo,
  form: 'https://forms.gle/2hPMpSjKVVRKrQnJ8',
  type: 'nonTechnical',
  rulebook: "https://forms.gle/2hPMpSjKVVRKrQnJ8",
  tag: " Rewards & Certificates",
  deadline: "12 MARCH 2025",
  teamCount: [
    "3 MEMBERS"
  ...
  info: [
    "Get ready to experience the thrill of bidding at TechFest 2K25’s IPL Auction! This exciting event lets you step into the shoes of a franchise owner, strategizing and bidding to build the ultimate cricket team within a set budget. Test your decision-making, negotiation skills, and cricket knowledge as you compete to create the strongest squad. May the best team win the championship! 🏆🎉"
  ],
  eligibility: [
    "Open to all students from any background with valid ID cards."
  ],
  ...
  /// 9. Action Speaks
  {
    ...
    form: 'https://forms.gle/p9TJG1Q2JDNaCZrm7',
    type: "nonTechnical",
    rulebook: "https://forms.gle/p9TJG1Q2JDNaCZrm7",
    tag: "Rewards & Certificates",
    fee: "RS 100(PER TEAM)",
    deadline: "12 MARCH 2025",
    teamCount: [
    ...
    info: [
      "Are you a true music lover? Melody Masters at TechFest 2K25 is the ultimate test of your music knowledge! In this fun-filled event, participants will be given intermediate lines from popular songs, and they must guess the correct song name. The faster you answer, the more points you earn! 🎼✨ Get ready to challenge your musical memory, compete with friends, and prove that you’re the ultimate Melody Masters! 🎤🔥"
    ],
    eligibility: [
      "Open to all students from any background with valid ID cards."
    ],
