        ...
        >
            <div class="basis-full flex flex-row gap-10 flex-wrap justify-evenly md:basis-3/3 ">
                <div>
                    ...
                    <p class="mt-2 text-sm text-dimWhite">Our friendly team is here to help.<br/> Instead <a href='https://wa.me/7010037147' className=' text-accent font-semibold'>Whatsapp</a></p>
                    <a href='mailto:gobinathan2003@gmail.com' rel='noopener' target='_top' class="mt-2 text-sm cursor-pointer text-accent">gobinathan2003@gmail.com</a>
                </div> 
                ...
                <div>
                    ...
                    <a class="mt-2 text-base font-[500] cursor-pointer text-accent" rel="noreferrer" target='_blank' href="tel:7010037147">7010037147</a>
                </div>
            </div>
